...
Open/Closed Principle means existing code should not be modified for every new requirement. 
Instead, we should extend it using inheritance, abstraction, or polymorphism.
"""
